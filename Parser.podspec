#
#  Be sure to run `pod spec lint Parser.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "Parser"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of Parser."
  ...
  spec.homepage     = "http://EXAMPLE/Parser"
  ...
  spec.source       = { :git => "http://EXAMPLE/Parser.git", :tag => "#{spec.version}" }
